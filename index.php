...
include('server/controller_limit_blogs.php');
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="section-title">
					...
					<span>Here you can checkout our favourite products</span>
				</div>
			</div>
		</div>
...
<section class="latest spad">
	<div class="container">
		...
		<div class="row">
			<?php while ($row = $limit_blogs->fetch_assoc()) { ?>
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="blog__item">
						<div class="blog__item__pic set-bg" data-setbg="<?php echo 'img/blog/' . $row['blog_image']; ?>"></div>
						<div class="blog__item__text">
							<span><i class="fas fa-calendar-alt"></i><?php echo date('d F Y', strtotime($row['blog_date'])); ?></span>
