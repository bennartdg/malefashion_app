					...
					<div class="checkout__order">
						...
						<div class="row">
							...
							<div class="col-sm-6 col-md-8">
								...
								<small><cite title="Address"> <i class="fa fa-map"></i>
							...
							<?php foreach ($user_orders as $order) { ?>
								<tr>
									<td class="product__cart__item">
										<div class="product_cart__item__text">
											<h6><?php echo $order['order_id']; ?></h6>
										</div>
									</td>
									<td class="product__cart__id">
									...
									<td class="product__cart__id">
										<div class="product__cart__item__text">
											<h6><?php echo setRupiah($order['order_cost'] * $kurs_dollar); ?></h6>
										</div>
									</td>
									<td class="product__cart__id">
										<div class="product__cart__item__text">
