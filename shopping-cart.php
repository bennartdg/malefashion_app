								...
								<?php foreach ($_SESSION['cart'] as $key => $value) { ?>
									<tr>
										...
										<form method="POST" action="shopping-cart.php">
											<td>
												<input type="hidden" name="product_id" value="<?php echo $value['product_id']; ?>">
												<button type="submit" class="btn btn-btn-danger" name="remove_product"><i class="fa fa-trash"></i></button>
											</td>
										</form>
									</tr>
								<?php } ?>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6">
						<div class="continue__btn">
							<a href="shop.php" class="btn btn-primary">Continue Shopping <i class="fa fa-arrow-circle-o-right"></i></a>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6">
